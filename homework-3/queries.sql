...
FROM customers
INNER JOIN employees ON customers.contact_title=employees.title
...
--Да, я знаю, что на скриншоте чуть-чуть не так, но увы, друзья, я смог только так((
